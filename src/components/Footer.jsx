...
const footerBg =
  "https://plus.unsplash.com/premium_photo-1661290203802-e70e01de3a3c?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
  ...
  return (
    ...
    >
        ...
        >
          ...
          <Box
            sx={{
              ...
              gap: 1.2,
              mt: 1,
              alignItems: "center", // center links
            }}
          >
            {quickLinks.map((link, index) => (
              <Typography
                ...
                sx={{
                  ...
                  "&:hover": {
                    color: "#3FB8AF",
                    transform: "translateX(5px)", // looks better centered than padding-left
                    transition: "0.3s",
                  },
                }}
              >
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          ...
          <Box sx={{ color: "#eee" }}>
            <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
              ...
              >
                1201 A, 12th floor, Tower T3, NX One, Greater Noida west .
                Corporate office
              </Typography>
            </Box>
            <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
      ...
      >
        ...
        >
          © {new Date().getFullYear()} Spirale Infosoft . All Rights Reserved.
        </Typography>
        <Typography
          variant="caption"
          sx={{
