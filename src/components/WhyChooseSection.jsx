      ...
      <Grid container spacing={{ xs: 4, md: 6 }} alignItems="center">
        ...
        <Grid size={{ xs: 12, md: 6 }} order={{ xs: 1, md: 2 }}>
          <Box sx={{ px: { xs: 0, sm: 1, md: 2 } }}>
            ...
            >
              Vestal Nursing Care is committed to delivering professional,
              compassionate, and dependable home nursing services. Our focus is
              on patient safety, comfort, and dignity while supporting families
              with trusted healthcare at home.
            </Typography>
