...
const AboutSection = () => {
    ...
    return (
        <Box sx={{ py: 5, backgroundColor: "#fff", overflow: "hidden", px: { xs: 2, sm: 3, md: 5 }, }}>
            <Grid
                container
                spacing={6}
                alignItems="center"
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                    ...
                    >
                        <Box sx={{ maxWidth: 500, }}>
                            ...
                            >
                                Compassionate nursing care for your loved ones
                            </Typography>
                            ...
                            >
                                At Vestal Nursing Care, we provide professional, compassionate nursing services tailored to meet the unique needs of each patient. Our team of licensed nurses and caregivers is dedicated to ensuring the highest quality of care in the comfort of your home. We believe in treating every patient with dignity, respect, and personalized attention.
                            </Typography>

                           
                            
                            <FormControlLabel
                                control={<Checkbox sx={{ color: "#3FB8AF" }} />}
                                label={
