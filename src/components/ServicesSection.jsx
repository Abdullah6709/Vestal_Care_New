...
const OurServiceSection = () => {
  return (
    ...
    >
      <Typography
        variant="h6"
        sx={{ color: "#E91E63", mb: 1, fontWeight: "bold" }}
      >
        OUR SERVICES
      </Typography>
      ...
      >
        Vestal Healthcare delivers reliable, professional, and personalized
        healthcare services at home, ensuring comfort, dignity, and peace of
